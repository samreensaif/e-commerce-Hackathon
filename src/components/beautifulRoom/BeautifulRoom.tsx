  ...
  return (
    <section className="relative flex gap-[34px] justify-between items-center py-[44px]">
      ...
      <div className=" flex gap-[20]">
        ...
        {/* 1 */}
        <div className=" relative w-[328px] h-[582px] bg-yellow-400">
          <Image src="/room1.png" alt="room1" layout='fill' objectFit="cover"></Image>
        </div>

        {/* 2 */}
        <div className=" relative w-[302px] h-[486px] bg-red-300">
          <Image src="/room2.png" alt="room1" layout='fill' objectFit="cover"></Image>
        </div>
        
        {/* 3 */}
        <div className=" relative w-[302px] h-[486px] bg-blue-300">
          <Image src="/room1.png" alt="room1" layout='fill' objectFit="cover"></Image>
        </div>
